...
export default {
    ...
    mounted() {
        ...
        $(window).on('DOMContentLoaded', () => {
            // данный код размещен здесь, а не в data для того, чтобы лента со слайдами
            // скрывалась только при реальной загрузке страницы, а не при переходе
            // с другого лэйаута при no-lazy loading
